...
namespace TileEngine
{
    public class SpriteAnimation
    {
        ...
        protected Texture2D t2dTexture;

        // True if animations are being played
        protected bool bAnimating = true;
        ...
        protected Vector2 v2Position = new Vector2(200, 200);
        protected Vector2 v2LastPosition = new Vector2(0, 0);

        // Dictionary holding all of the FrameAnimation objects
        // associated with this sprite.
        protected Dictionary<string, FrameAnimation> faAnimations = new Dictionary<string, FrameAnimation>();

        // Which FrameAnimation from the dictionary above is playing
        protected string sCurrentAnimation = null;
